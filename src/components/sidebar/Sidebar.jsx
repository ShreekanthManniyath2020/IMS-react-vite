...
import { setSidebarClose } from "../../features/sideBar/sidebarSlice";
        ...
        <div className="sidebar-menu">
          <ul className="menu-list">
            <li className="menu-item">
              <Link to="/*" onClick={() => setIsActive(1)} className={`menu-link ${isActive == 1 ? 'active' : ''}`}>
            ...
            <li className="menu-item">
              <Link to="/Products" onClick={() => setIsActive(2)} className={`menu-link ${isActive == 2 ? 'active' : ''}`}>
                <span className="menu-link-icon">
